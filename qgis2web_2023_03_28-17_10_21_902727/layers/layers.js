...
var format_Mall_2 = new ol.format.GeoJSON();
var features_Mall_2 = format_Mall_2.readFeatures(json_Mall_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Mall_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Mall_2.addFeatures(features_Mall_2);
var lyr_Mall_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Mall_2, 
                style: style_Mall_2,
                interactive: true,
                title: '<img src="styles/legend/Mall_2.png" /> Mall'
            });

lyr_GoogleMaps_0.setVisible(true);lyr_ADMINISTRASI_LN_50K_1.setVisible(true);lyr_Mall_2.setVisible(true);
var layersList = [lyr_GoogleMaps_0,lyr_ADMINISTRASI_LN_50K_1,lyr_Mall_2];
...
lyr_Mall_2.set('fieldAliases', {'Nama': 'Nama', 'Foto': 'Foto', });
...
lyr_Mall_2.set('fieldImages', {'Nama': 'TextEdit', 'Foto': 'ExternalResource', });
...
lyr_Mall_2.set('fieldLabels', {'Nama': 'no label', 'Foto': 'no label', });
lyr_Mall_2.on('precompose', function(evt) {
